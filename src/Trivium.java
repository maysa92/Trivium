...
public class Trivium {
    ...
    public void stringtoBinary(String string){
        String binary = "";
		int x;
    ...
    public void helper() {
    	...
    	for (int i = arrayC.length - 1; i >=0; i--) {
    	    ...
    	    else {arrayC[i] = arrayC[i-1];}
    	}
    	/*for(int i= 0; i < A_IV.length; i++) {
    	System.out.println(A_IV[i]);}*/	
    }
    ...
    public static void main(String[] args) {
        ...
        for (int y = 0; y < 1000; y++) {
        	System.out.print(tr.keystreamoutput[y]);
        }*/
        System.out.println();
        tr.encrypt(); 
